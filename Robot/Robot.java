...
public class Robot{
  ...
  */
  ...
  /*
  * Método que recibe la orden del cliente, por lo que cambia el valor del atributo
  * orden recibida.
  ...
  * @return EstadoRobot estado en el que se encuentra el robot cuando se manda a llamar el método.
  */
  ...
  *@param proximidad qué tan cerca o lejos se encuentra el robot de la mesa del cliente.
  */
  ...
  *@param sn s representa si (en referencia a que ya se llegó al destino) y n representa no
