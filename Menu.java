...
public abstract class Menu{
    ...
    String mostrarMenu() {
        ...
        menu += formatoColumna("a---------------------------------------------------------------------------------------------------------------------------------------------------------------------------c\n");
        if(nombre.equals("ESPECIAL")){
            menu += formatoFila("|                                                                                MENU " + nombre  + "                                                                              |\n");
        }
        ...
        menu += formatoFila("|                                                                                MENU GENERAL                                                                               |\n");
        menu += formatoColumna("g---------------------------------------------------------------------------------------------------------------------------------------------------------------------------i\n");
        menu += formatoColumna("a------b--------------------------b------b----------------------------------------------------------------------------------------------------------------------------------c\n");
        menu += formatoFila("|  ID  |          NOMBRE          |   $  |                                                        DESCRIPCIÓN                                                               |\n");
        menu += formatoColumna("d------e--------------------------e------e----------------------------------------------------------------------------------------------------------------------------------f\n");


        while(iteradorHamburgesas.hasNext()){
            Hamburguesa hamburguesa = iteradorHamburgesas.next();
            menu += formatoFila(String.format("| %4s | %-24s | %4s| %-76s |\n", hamburguesa.getId(), hamburguesa.getNombre(), numberFormat.format(hamburguesa.getPrecio()), hamburguesa.getDescripción()));
        }

        menu += formatoColumna("g------h--------------------------h------h----------------------------------------------------------------------------------------------------------------------------------i\n");
        return menu;
    }
